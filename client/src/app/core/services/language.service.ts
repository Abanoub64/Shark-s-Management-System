...
export class LanguageService {
  ...
  private translations: Record<Language, any> = {
    en: {
      ...
      branch: 'Branch',
      rating: 'Rating',
      tryAIHaircut: 'Try AI Haircut',
      aiHaircutRecommender: 'AI Haircut Recommender',
      aiHaircutSubtitle: 'Upload your photo and see how you look with different hairstyles instantly.',
      tryItNow: 'Try It Now',
      save: 'Save',
      update: 'Update',
      create: 'Create',
      ...
      selectBranchToView: 'Select Branch to View Analytics',
      ...
      occupiedChairs: 'Occupied Chairs',
      currentlyBusy: 'Currently busy',
      inLast: 'In last',
      averageRatingTitle: 'Average Rating',
      basedOn: 'Based on',
      ratings: 'ratings',
      noRatingsData: 'No ratings data available',
      selectABranch: 'Select a Branch',
      clickBranchAbove: 'Click on a branch above to view its analytics',
      last: 'Last',
    ...
    ar: {
      ...
      branch: 'الفرع',
      rating: 'التقييم',
      tryAIHaircut: 'جرب قص شعر بالذكاء الاصطناعي',
      aiHaircutRecommender: 'موصي قصات الشعر بالذكاء الاصطناعي',
      aiHaircutSubtitle: 'قم بتحميل صورتك وشاهد كيف تبدو بقصات شعر مختلفة فوراً.',
      tryItNow: 'جرب الآن',
      save: 'حفظ',
      update: 'تحديث',
      create: 'إنشاء',
      ...
      // Branch Analytics
      branchAnalytics: 'تحليلات الفروع',
      selectBranchToView: 'اختر فرع لعرض التحليلات',
      ...
      bookingsPerDay: 'الحجوزات في اليوم',
      noBookingData: 'لا توجد بيانات حجوزات متاحة',
      bookingsByStatus: 'الحجوزات حسب الحالة',
      noStatusData: 'لا توجد بيانات حالة متاحة',
      pendingQueue: 'قائمة الانتظار المعلقة',
      waitingCustomers: 'عملاء منتظرون',
      occupiedChairs: 'الكراسي المشغولة',
      currentlyBusy: 'مشغول حالياً',
      inLast: 'في آخر',
      averageRatingTitle: 'متوسط التقييم',
      basedOn: 'بناءً على',
      ratings: 'تقييمات',
      noRatingsData: 'لا توجد بيانات تقييم متاحة',
      selectABranch: 'اختر فرع',
      clickBranchAbove: 'انقر على فرع أعلاه لعرض تحليلاته',
      last: 'آخر',
