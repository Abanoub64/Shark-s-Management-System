...
namespace backend.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<AuthResponseDto> RegisterAsync(RegisterDto model)
        {
            ...
            // === Only Admin can create BranchManager ===
            ...
            // === Only BranchManager can create Barber for same branch ===
            ...
            return new AuthResponseDto
            {
                ...
                Message = $"User created successfully as {model.Role}"
            };
        }
        ...
        {
            var user = await _userManager.FindByEmailAsync(email);   // FIXED
        ...
        // ================= EXTERNAL LOGIN ====================
        public async Task<AuthResponseDto> LoginWithExternalAsync(
            string email,
